            ...
            stage('Sanity check') {
                steps {
                    emailext (
                        ...
                        body: "<html><body><center><h3>Cloning the Application from GitHub is succesful.Do you want to start the building of the project? <br> <br> <form action=${env.BUILD_URL}input> <input type=submit value=Approve?</form><</h2>/<center></body><html>",
                    attachLog: true,
                    )
                    script {
